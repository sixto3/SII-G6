...
public class InicializaBBDD {
	...
	public void inicializar(){
		...
		Referencia ref1 = new Referencia("VG57DDVS5173214964983931", (long) 5432, 
				"unicaja", "málaga", "España", 0 ,Date.valueOf("2018-11-16"), "activa", dolar);
		...
		Referencia ref2 = new Referencia("HN47QUXH11325678769785549996", (long) 5342, 
				"unicaja", "málaga", "España", 0 ,Date.valueOf("2016-12-09"), "activa", dolar);
		...
		Segregada segregada3 = new Segregada("DE31500105179261215675",(long) 6161,"cerrada",
				empresa.getFecha_Alta(),Date.valueOf("2021-09-01"),null,0,ref2,empresa);
		...
		Referencia ref3 = new Referencia("ES7121007487367264321882",(long) 6789,"unicaja","sucursal3","españa", 100, Date.valueOf("2016-12-09") ,"activa",euro);
		Referencia ref4 = new Referencia("VG88HBIJ4257959912673134",(long) 7896,"unicaja","sucursal4","españa", 200, Date.valueOf("2016-12-09") ,"activa",dolar);
		Referencia ref5 = new Referencia("GB79BARC20040134265953",(long) 8967,"unicaja","sucursal5","españa", 140, Date.valueOf("2016-12-09") ,"activa",libra);
		
		DepositadaEnId depId1 = new DepositadaEnId(pooled.getIBAN(), ref3.getIBAN());
		DepositadaEnId depId2 = new DepositadaEnId(pooled.getIBAN(), ref4.getIBAN());
		DepositadaEnId depId3 = new DepositadaEnId(pooled.getIBAN(), ref5.getIBAN());
